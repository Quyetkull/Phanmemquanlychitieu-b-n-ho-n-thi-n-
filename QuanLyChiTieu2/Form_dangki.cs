...
namespace QuanLyChiTieu2
{
    public partial class Form_dangki : Form
    {
        ...
        string chuoiketnoi = @"Data Source=DESKTOP-DHFMQ88\MSSQLSERVER03;Integrated Security=SSPI;Initial Catalog=Quanlychitieu";
        string sql;
        ...
        private void Form_dangki_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
